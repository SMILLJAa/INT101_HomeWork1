...
import work04.Person;
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println("BMI = "+ calculateBMI(68, 177));
   ...
   static void work04UseOfObjectClass() {
      ...
      */
        ...
        BankAccount account1 = new BankAccount(01, person1);
        BankAccount account2 = new BankAccount(02, person2);

        account1.deposit(369.69999);
        ...
        double transferAmount = 123.45678;
